...
/**
 * Full PHPUnit test for the District class
 *
 * This is a complete PHPUnit test of the District class. It is complete because *ALL* mySQL/PDO enabled methods
 * are tested for both invalid and valid inputs.
 *
 * @author Dylan McDonald <dmcdonald21@cnm.edu>
 * @edited Steven Hebert <shebert2@cnm.edu>
 **/
